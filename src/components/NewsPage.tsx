        ...
        <div>
            ...
            {view ? 
                <div className={styles.blog}>
                    ...
                    <div key={index * currentPage}>
                        ...
                        <a href={news.link} className={styles.readMore}>Подробнее</a>
                    </div>
                    ))}
                </div>       
                :
            ...
            {currentPage > 3 ?
                    <nav className={styles.nav}>
                        ...
                        <Link className={styles.active} href={"/" + (currentPage)}>{currentPage}</Link>
                        <Link href={"/" + (currentPage + 1)}>{currentPage + 1}</Link>
                        ...
                    ...
                    :
                    <nav className={styles.nav}>
                        <Link className={pathname === "/1" ? styles.active : "" } href={"/1"}>1</Link>
                        <Link className={pathname === "/2" ? styles.active : "" }  href={"/2"}>2</Link>
                        <Link className={pathname === "/3" ? styles.active : "" }  href={"/3"}>3</Link>
                        <Link className={pathname === "/4" ? styles.active : "" }  href={"/4"}>4</Link>
                        ...
                        <Link href={"/" + maxLengthLinks}>{maxLengthLinks}</Link>
                    </nav>
                }  
